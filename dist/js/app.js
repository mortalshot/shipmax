(() => {
    ...
    document.addEventListener("click", (function(e) {
        const targetElement = e.target;
        if (targetElement.classList.contains("search-form__toggle") || targetElement.closest(".header__search")) targetElement.closest(".header__container").classList.add("_show-search"); else document.querySelector(".header__container").classList.remove("_show-search");
        ...
        if (targetElement.classList.contains("password__button")) {
            ...
            if (targetElement.closest(".password__input").classList.contains("_show")) document.querySelector(".password__input .form__input").type = "text"; else document.querySelector(".password__input .form__input").type = "password";
        }
    }));
    window["FLS"] = true;
    isWebp();
